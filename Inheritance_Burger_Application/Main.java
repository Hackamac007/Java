...
*/
        ...
        Hamburger ham = new Hamburger("Basic", "Sausage", 4, "White");
        double price = ham.itemizeHamburger();
        ham.addHumburgerAddtion1("tomato",2);
        ham.addHumburgerAddtion2("Letuce", 3);
        System.out.println("Total price for hamburger is: "+ ham.itemizeHamburger());

        HealthyBurger  healthyBurger= new HealthyBurger("Beaf",6);
        healthyBurger.addHumburgerAddtion1("rice",3); // Normal addition
 //       System.out.println("Total price for Healthy hamburger with normal addition is: "+healthyBurger.itemizeHamburger());
        healthyBurger.addhealthAddtion1("Beadaa", 4);  // Health addition
        System.out.println("Total price for Healthy hamburger with health addition is: "+healthyBurger.itemizeHamburger());
